<template>
    <div class="backgroundTaskNewGirl" :style="{ background: 'url(' + require('../../assets/' + screen.imgURL + '.webp') + ')'}">
        ...
        <div class="background-text" id="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskNewGirl.results.ULSE2_Log_SEK3 !== 'NA'">Готово</MyButton>
...
export default {
    ...
    methods: {
        ...
        chooseAnswer(el){
            this.mainJSON.taskNewGirl.results.ULSE2_Log_SEK3 = el.id
        },
        checkAnswer() {

                screen.isShow = false
                if(this.mainJSON.taskNewGirl.results.ULSE2_Log_SEK3 === 2){
                    this.mainJSON.taskNewGirl.results.ULSE2_Score_SEK3 = 1
                    this.mainJSON.taskNewGirl.shownScreenID++
                }
                else {
                    this.mainJSON.taskNewGirl.results.ULSE2_Score_SEK3 = 0
