    ...
    <div class="backgroundTaskNewGirl"
        ...
        <div class="d-flex justify-content-center align-items-center w-100"
            ...
            <div class="option-answers-background">
                <div v-for="el in constTaskNewGirl.listOfAnswersDuck" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskNewGirl.results.ULSE2_Log_SES1}"
        ...
        <div class="background-text" id="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskNewGirl.results.ULSE2_Log_SES1 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskNewGirl.results.ULSE2_Log_SES1 = el.id
            },
            checkAnswer() {
                screen.isShow = false
