<template>
    ...
    <div v-if="(currentScreenConst.id === 7 && this.mainJSON.taskChatFestival.results.ULHLDT2_Log_HLK3_1 !== 2) ||
                ...
                (currentScreenConst.id === 15 && this.mainJSON.taskChatFestival.results.ULHLDT2_Log_HLK4_1 !== '1') &&
                (currentScreenConst.id === 15 && this.mainJSON.taskChatFestival.results.ULHLDT2_Log_HLK4_1 !== '3')) ||
