...
export default {
    ...
    mounted(){
        ...
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK1_2 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK1_2 === 2){
            this.securityInTheCity+=2
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK1_3 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK2_1 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK2_2 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK2_3 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCS4_1 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK1_4 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCS4_2 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCS4_3 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK3_1 === 1){
            this.securityInTheCity++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_SCK3_2 === 1){
            this.securityInTheCity++
        }


        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK1_1 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK1_2 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK1_3 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK1_4 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK3_1 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK3_1 === 2){
            this.localLiteracy+=2
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK2_1 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK4_1 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK5_1 === 1){
            this.localLiteracy++
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK5_1 === 2){
            this.localLiteracy+=2
        }
        if(this.mainJSON.task1.results.ULSCLL1_Score_LLK6_1 === 1){
            this.localLiteracy++
        }
        ...
        if(this.mainJSON.task3.results.ULSE1_Score_SEK4_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK4_2 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK3 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK3_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK3_1 === 2){
            this.prosocialEngagement+=2
        }
        if(this.mainJSON.task3.results.ULSE1_Score1_SEK2_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK2_2 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score1_SEK1_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score2_SEK1_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score3_SEK1_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score1_SEK5_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score2_SEK5_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK6_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK6_1 === 2){
            this.prosocialEngagement+=2
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES1_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES2 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES3 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES4 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES5 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK3_3 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SEK3_3 === 2){
            this.prosocialEngagement+=2
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES5_1 === 1){
            this.prosocialEngagement++
        }
        if(this.mainJSON.task3.results.ULSE1_Score_SES1 === 1){
            this.prosocialEngagement++
        }
